...
public class PageViewDriver_ver2 extends Configured implements Tool{
	...
	public int run(String[] optionlist) throws Exception {
		...
		job.setJarByClass(PageViewDriver_ver2.class);
	...
	public static void main(String[] args) throws Exception {
		ToolRunner.run(new Configuration(), new PageViewDriver_ver2(), args);
	}
}
