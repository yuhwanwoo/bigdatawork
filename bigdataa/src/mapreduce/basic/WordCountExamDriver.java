...
public class WordCountExamDriver {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
		...
		job.setMapperClass(WordCountExamMapper.class);
		job.setReducerClass(WordCountExamReducer.class);
		job.setJarByClass(WordCountExamDriver.class);
