...
public class AirMultipleDriver extends Configured implements Tool{
	...
	public int run(String[] optionlist) throws Exception {
		...
		Job job = new Job(getConf(), "airmulti");
		...
		MultipleOutputs.addNamedOutput(job, "na14", TextOutputFormat.class, Text.class,IntWritable.class);
		MultipleOutputs.addNamedOutput(job, "na15", TextOutputFormat.class, Text.class,IntWritable.class);
