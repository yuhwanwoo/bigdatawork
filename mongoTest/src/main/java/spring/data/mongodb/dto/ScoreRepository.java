...
// 지원되는 여러가지 편한 기능을 사용할 수 있다. - 설정파일등록
// 자동으로 지원되는 기능을 사용할 수 있도록 하려면 상속받아야 한다.
//									------
//						PagingAndSortingReopsitory,	CrudRepository
//						(기본CRUD와 paging처리,			(기본CRUD기능)
//							sort기능을 지원
//mongodb에 저장되어 있는 컬렉션의 데이터를 엑세스할 수 있는 기능을 프레임워크 내부에서 지원하며
